...
public class TelaCliente extends javax.swing.JInternalFrame {
    ...
    private void adicionar() {
        String sql = "insert into tbclientes(nomecli,endcli,fonecli,emailcli,cepcli) values(?,?,?,?,?)";
        try {
            ...
            if ((txtCliNome.getText().isEmpty()) || (txtCliEndereco.getText().isEmpty()) || (txtCliFone.getText().isEmpty()) || (txtCliCep.getText().isEmpty())) {
    ...
    private void pesquisar_cliente() {
        String sql = "select idcli as id, nomecli as nome, endcli as endereço, fonecli as telefone, emailcli as email, cepcli as cep from tbclientes where nomecli like ?";
        try {
            pst = conexao.prepareStatement(sql);
            //passando o conteudo da caixa de pesquisa para o ?
            pst.setString(1, txtCliPesquisar.getText() + "%");
            rs = pst.executeQuery();
            //a linha abaixo utiliza a biblioteca rs2xml.jar para preencher a tabela
    ...
    private void alterar() {
        String sql = "update tbclientes set nomecli=?,endcli=?,fonecli=?, emailcli=?, cepcli=? where idcli=?";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, txtCliNome.getText());
            pst.setString(2, txtCliEndereco.getText());
    ...
    private void initComponents() {
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/reisschool/icones/pesquisar.png"))); // NOI18N
        ...
        tblClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "nome", "endereço", "telefone", "email", "cep"
            }
        ));
        ...
        btnAdicionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/reisschool/icones/create.png"))); // NOI18N
        ...
        btnAlterar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/reisschool/icones/update.png"))); // NOI18N
        ...
        btnRemover.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/reisschool/icones/delete.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(60, 60, 60)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txtCliCep, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtCliNome, javax.swing.GroupLayout.DEFAULT_SIZE, 397, Short.MAX_VALUE)
                            .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtCliEmail, javax.swing.GroupLayout.PREFERRED_SIZE, 397, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        //chamando o metodo de alterar clientes
        alterar();
    ...
    //o evento abaixo é do tipo enquanto for ditando
